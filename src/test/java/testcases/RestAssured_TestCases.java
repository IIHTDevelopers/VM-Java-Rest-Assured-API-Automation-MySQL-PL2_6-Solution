...
public void deleteOAuthClient() throws IOException {
	...
	public static int getLastOAuthClientId(String cookieValue) {
        String url = "https://yakshahrm.makemylabs.in/orangehrm-5.7/web/index.php/api/v2/admin/oauth-clients?limit=50&offset=0";
    ...
    String endpoint = "https://yakshahrm.makemylabs.in/orangehrm-5.7/web/index.php/api/v2/auth/openid-providers";
    ...
    Response response = RestAssured.given()
            ...
            .header("Content-Type", "application/json")
            .when()
            .get("https://yakshahrm.makemylabs.in/orangehrm-5.7/web/index.php/api/v2/auth/openid-providers?limit=50&offset=0")
            .then()
            .extract()
            .response();
	...
	public int getfirstlangid() {
	    String url = "https://yakshahrm.makemylabs.in/orangehrm-5.7/web/index.php/api/v2/admin/i18n/languages?limit=50&offset=0&sortOrder=ASC&activeOnly=true";
